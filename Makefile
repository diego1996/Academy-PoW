...
run-node-server:
	docker-compose -f docker-compose.server.yml up -d --build && docker-compose -f docker-compose.server.yml logs -f
...
run-node-user:
	docker-compose -f docker-compose.user.yml up -d --build && docker-compose -f docker-compose.user.yml logs -f
